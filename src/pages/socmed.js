...
export default (() => {
	return <Theme theme={theme}>
		...
		<Section padding="100px 0 0 0" background="#ffffff url() 50% 50% /cover repeat scroll padding-box" quarkly-title="Hero-17" transition="background-color 0.2s ease 0s">
